				...
				switch(table){
					case "users": {
						...
						switch(version){
							...
							case 2:{
								querys.push("ALTER TABLE `users` ADD COLUMN `background_id` INTEGER DEFAULT 1;");
								querys.push("ALTER TABLE `users` ADD COLUMN `award_id` INTEGER DEFAULT 1;");
								version = 3;
							}
